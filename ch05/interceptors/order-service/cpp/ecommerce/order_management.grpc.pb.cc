...
std::unique_ptr< OrderManagement::Stub> OrderManagement::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< OrderManagement::Stub> stub(new OrderManagement::Stub(channel));
  return stub;
}

OrderManagement::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_addOrder_(OrderManagement_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getOrder_(OrderManagement_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_searchOrders_(OrderManagement_method_names[2], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_updateOrders_(OrderManagement_method_names[3], ::grpc::internal::RpcMethod::CLIENT_STREAMING, channel)
  , rpcmethod_processOrders_(OrderManagement_method_names[4], ::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}
...
void OrderManagement::Stub::experimental_async::addOrder(::grpc::ClientContext* context, const ::ecommerce::Order* request, ::google::protobuf::StringValue* response, std::function<void(::grpc::Status)> f) {
...
void OrderManagement::Stub::experimental_async::addOrder(::grpc::ClientContext* context, const ::ecommerce::Order* request, ::google::protobuf::StringValue* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void OrderManagement::Stub::experimental_async::getOrder(::grpc::ClientContext* context, const ::google::protobuf::StringValue* request, ::ecommerce::Order* response, std::function<void(::grpc::Status)> f) {
...
void OrderManagement::Stub::experimental_async::getOrder(::grpc::ClientContext* context, const ::google::protobuf::StringValue* request, ::ecommerce::Order* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void OrderManagement::Stub::experimental_async::searchOrders(::grpc::ClientContext* context, const ::google::protobuf::StringValue* request, ::grpc::experimental::ClientReadReactor< ::ecommerce::Order>* reactor) {
...
void OrderManagement::Stub::experimental_async::updateOrders(::grpc::ClientContext* context, ::google::protobuf::StringValue* response, ::grpc::experimental::ClientWriteReactor< ::ecommerce::Order>* reactor) {
...
void OrderManagement::Stub::experimental_async::processOrders(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::google::protobuf::StringValue,::ecommerce::CombinedShipment>* reactor) {
