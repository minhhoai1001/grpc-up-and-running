# `Echo` Service and Client - Go Implementation
## Generate Go language code from the `echo.proto` file
```
protoc -I ../../proto/ --go_out=plugins=grpc:echo ../../proto/echo.proto
```
## Building and Running Server
In order to build, Go to Go module root directory location (`echo/go/server`) and execute the following shell command,
```
...
In order to build, Go to Go module root directory location (`echo/go/client`) and execute the following shell command,
```
